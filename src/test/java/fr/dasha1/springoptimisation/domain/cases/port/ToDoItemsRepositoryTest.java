...
import fr.dasha1.springoptimisation.infra.db.ToDoItem;
...
class ToDoItemsRepositoryTest {
    ...
    public void model_items_converted_returned() {
        ...
        when(toDoItemsRepositoryMock.findAllByStatusIsNot(Status.DONE))
                .thenReturn(
                  Arrays.asList(new ToDoItem("ABCF", "Item 1", "Item 1 Descr", Status.NEW, dueDate),
                                new ToDoItem("AFCF", "Item 2", "Item 2 Descr",Status.NEW, dueDate),
                                new ToDoItem("AFC6", "Item 3", "Item 3 Descr",Status.NEW, dueDate)));

        assertThat(toDoItemsRepository.getAllNotDone())
                .allMatch(toDoItem -> toDoItem.getStatus() != Status.DONE)
                .containsExactly(
                        new fr.dasha1.springoptimisation.domain.model.ToDoItem("ABCF", "Item 1", "Item 1 Descr", dueDate),
                        new fr.dasha1.springoptimisation.domain.model.ToDoItem("AFCF", "Item 2", "Item 2 Descr", dueDate),
                        new fr.dasha1.springoptimisation.domain.model.ToDoItem("AFC6", "Item 3", "Item 3 Descr", dueDate));
    }
